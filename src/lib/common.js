...
/**
 * [居中函数]
 * @param  {Element} ele    [要居中的元素]
 */
//ele得先加css属性：position:relative || absolute
function autoCenter(ele){
    let left = window.innerWidth/2 - ele.offsetWidth/2;
    let top = window.innerHeight/2 - ele.offsetHeight/2;
